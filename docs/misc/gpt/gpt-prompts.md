...
```
我正在备考雅思，下面我将给你一个单词，或短语。请你结合这个单词和雅思考试，撰写一个小故事，或者能让我对这个表达加深印象的材料，帮助我记忆这个单词，同时有利于备考。
```

## 题目与解答

```
阅读题目，以将其制作成考题的标准对题干进行润色、优化，并给出参考答案。
```
...
3. 文中涉及的专业术语或缩略词，请统一备注英文原文，格式如下：
	若为缩略词：缩略词（全称英文），例如：CPU（Central Processing Unit）
	若为术语：中文术语（英文），例如：中断向量表（Interrupt Vector Table）
4. 在笔记开头，给出推荐的文件名，格式为：以主题关键词为核心，单词用中划线连接（如：cpu-pipeline-hazards.md），文件名要简明、准确、有助于检索和URL使用。
```
